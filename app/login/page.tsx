...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-svh overflow-hidden bg-[#050508] text-[#E0E0E6] flex items-center justify-center p-6">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -right-24 bottom-24 -z-0 h-[500px] w-[500px] rounded-full opacity-15 blur-[120px] animate-blob-alt will-change-transform"
        style={{ background: "oklch(0.6 0.16 250)" }}
      />
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-4xl font-black tracking-tighter italic uppercase text-center">{t.login_title}</h1>
          <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-[0.2em] mt-2 opacity-50">{t.login_subtitle}</p>
        </div>
